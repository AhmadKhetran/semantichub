...
export default function AddConnectionForm({ onSubmit, onCancel }: AddConnectionFormProps) {
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="w-full">
              ...
              <Select value={formData.type} onValueChange={(value) => handleInputChange("type", value)}>
                ...
                <SelectContent>
                  <SelectItem value="PostgreSQL">Air Line</SelectItem>
                  <SelectItem value="MySQL">Medical</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="w-full">
              ...
              <Select value={formData.datasource} onValueChange={(value) => handleInputChange("datasource", value)}>
                ...
                <SelectContent>
                  <SelectItem value="production">Postgres</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
